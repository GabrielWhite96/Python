...
class Personalize_bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(
            'assets/sprites/bird.png').convert_alpha()
        self.image = pygame.transform.scale(self.image, (100, 100))
        self.rect = self.image.get_rect()
...
class Personalize_background(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(
            'assets/sprites/background.png').convert_alpha()
        self.image = pygame.transform.scale(self.image, (100, 100))
        self.rect = self.image.get_rect()
...
class Personalize_button(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(
            'assets/sprites/personalizar_button.png').convert_alpha()
...
class Bird(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.image = pygame.transform.rotate(
            self.image, -1.5 * self.FALLING_SPEED)
...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self, inverted, xpos, ysize):
        ...
        self.image = pygame.image.load(
            'assets//sprites//pipe-black.png').convert_alpha()
...
while True:
    ...
    if is_off_screen(pipe_group.sprites()[0]):
        ...
        pipes = get_random_pipes(WIDTH_SCREEN * 2 - 80)
